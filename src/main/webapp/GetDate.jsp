...
<title>Delivery Management System: Get Order By Date</title>
...
<body>
	...
	<h1 class="text-center">Get Order By Date</h1>
	<div class="text-center">Enter the Date to retrieve the Order Details.</div>
	<form class="form-horizontal" action="GetOrdersByDate" method="POST">
		<div class="form-group row">
			...
			<div class="col-8">
				<div class="input-group">
					...
					<input id="orderDate" name="orderDate" placeholder="Format: YYYY-MM-DD. (e.g. 2019-04-30)" type="text" class="form-control">
				</div>
			</div>
		</div>
		<c:if test="${empty loggedin}">
			<input class="btn btn-secondary offset-4 col-4" type="submit" value="Submit" name="submitButton" disabled>
		</c:if>
		<c:if test="${not empty loggedin}">
			<input class="btn btn-primary offset-4 col-4" type="submit" value="Submit" name="submitButton">
		</c:if>
	</form>
