...
<title>Delivery Management System: Remove Order</title>
...
<body>
	...
	<h1 class="text-center">Remove Order</h1>
	<div class="text-center">Enter the Order Number to retrieve the Order Details.</div>
	<form class="form-horizontal" action="RemoveOrder" method="POST">
