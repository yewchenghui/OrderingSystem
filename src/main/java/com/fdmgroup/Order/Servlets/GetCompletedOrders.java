...
public class GetCompletedOrders extends HttpServlet {
	Logger logger = LogManager.getLogger(GetCompletedOrders.class);
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<Order> ordersList = orderDAO.getOrderByState(2, false);
